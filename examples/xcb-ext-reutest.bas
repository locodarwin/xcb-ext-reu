...
dim lorem$ as string * 40
dim fox$ as string * 40
lorem$ = "Lorem ipsum dolor sit amet, consectetur"
fox$ = "The quick brown fox jumped over the"
...
for x as byte = 1 to 24
    print lorem$
'	print fox$
next x
a = reu_trans(STASH, 1000, $0400, $0000, BANK) ' mixed hex and decimal notation
...
for x = 1 to 24
    print fox$ 
next x
a = reu_trans(STASH, $0400, $0400, $0401, BANK) ' pure hex notation

call clrs()
textat 1, 5, "Next, we will flip between the screens"
textat 2, 6, "2 times each, waiting for key press"
textat 1, 7, "each time - remember to press any key"
textat 2, 8, "a total of 4 times to complete the"
...
for x = 0 to 1
    a = reu_trans(FETCH, 1000, $0400, $0000, BANK)
    call presskey()
    b = reu_trans(FETCH, 1000, $0400, $0401, BANK)
    call presskey()
next x
...
a = reu_trans(STASH, 1000, 49152, 0, BANK) ' pure decimal notation
...
' swap 5 times!
for x = 0 to 4
    a = reu_trans(SWAP, 1000, $0400, $0000, BANK)   ' mixed hex and decimal notation
    call presskey()
next x
